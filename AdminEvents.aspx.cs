...
namespace HomeSync
{
    public partial class Events : System.Web.UI.Page
    {
        ...
        protected void ADMINButton1(object sender, EventArgs e)
        {
        ...
        protected void ADMINButton2(object sender, EventArgs e)
        {
            string connStr = WebConfigurationManager.ConnectionStrings["HomeSyncConnection"].ConnectionString;
        ...
        protected void ADMINButton3(object sender, EventArgs e)
        {
            string connStr = WebConfigurationManager.ConnectionStrings["HomeSyncConnection"].ConnectionString;
        ...
        protected void ADMINButton4(object sender, EventArgs e)
        {
            string connStr = WebConfigurationManager.ConnectionStrings["HomeSyncConnection"].ConnectionString;
        ...
        protected void ADMINButton5(object sender, EventArgs e)
        {
            string connStr = WebConfigurationManager.ConnectionStrings["HomeSyncConnection"].ConnectionString;

            using (SqlConnection conn = new SqlConnection(connStr))
            {
                SqlCommand RemoveEvents = new SqlCommand("RemoveEvent", conn);
                RemoveEvents.CommandType = CommandType.StoredProcedure;

                RemoveEvents.Parameters.AddWithValue("@event_ID", R1.Text);
                RemoveEvents.Parameters.AddWithValue("@user_id", R2.Text);
                ...
                {
                    conn.Open();
                    RemoveEvents.ExecuteNonQuery();

                    SqlDataReader reader = RemoveEvents.ExecuteReader();


                    conn.Close();

                    Response.Write("Successfully Deleted Event  ");
                }
                catch (SqlException ex)
                {
                    Response.Write("Error: " + ex.Message);
